...
const schema = z.object({
  ...
  preco: z.union([z.string(), z.coerce.number().positive('Informe um preço válido')]),
  tipo: z.enum(['casa', 'apartamento', 'terreno', 'comercial']),
  status: z.enum(['disponivel', 'vendido', 'alugado', 'reservado']),
  cidade: z.string().min(2, 'Informe a cidade'),
  bairro: z.string().optional(),
  endereco: z.string().optional(),
  quartos: z.union([z.string(), z.coerce.number().int().min(0)]).optional(),
  banheiros: z.union([z.string(), z.coerce.number().int().min(0)]).optional(),
  vagas: z.coerce.number().int().min(0).default(0),
  area_m2: z.union([z.string(), z.coerce.number().positive()]).optional(),
